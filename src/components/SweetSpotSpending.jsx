...
export default function SweetSpotSpending({ ledger = [], accounts = [] }) {
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div>
          <div style={{ fontSize: 18, fontWeight: 700, color: "#111827", display: "flex", alignItems: "center", gap: 8 }}>
            <Plane size={18} /> My spending
          </div>
          <div style={{ fontSize: 13, color: "#6b7280", marginTop: 4 }}>
            Miles earned from your card spending, and what the best card would have earned. Uses the rule snapshot from 27 Aug 2026, not the live catalog yet.
          </div>
        </div>
